  ...
  if(!uID || !d || !r){
    ...
    (error, results) => {
      if (error) {
          ...
          return res.render("feedback", { message: "Thank you for your Feedback" });   //redirects user to main after they successfully submit and info enters the database correctly
      }
  });
