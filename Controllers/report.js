    ...
    return res.json({ status: "error", error: "Please enter ALL information" });    //returns error to user if all information is not provided
        ...
        (error, results) => {
          if (error) {
              ...
              return res.render("report", { message: "Your Report has been received, Refund will be issued in 24hrs" });   //successfully inserted in database and redirects to main page
          }
      });
