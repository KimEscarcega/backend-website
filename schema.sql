...
create table feedback(fID int unsigned not null, uID int unsigned, text varchar(150), primary key(fID), foreign key(uID) references user(uID) on update cascade);
